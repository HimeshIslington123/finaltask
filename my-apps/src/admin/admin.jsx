      ...
      <div className="flex-[1] flex flex-col justify-around border border-gray-300 h-full p-[10px] bg-gray-100 rounded-lg shadow-sm">
        ...
        <ul className="flex flex-col gap-[10px] text-[12px] sm:text-[25px]">
          <li>
            <Link
              to="task"
              className="block border bg-blue-400 text-white text-center border-blue-500 rounded-full py-[6px] sm:py-[10px]"
            >
              task
            </Link>
          </li>
        ...
        <button
          ...
          className="bg-red-500 text-white px-4 py-2 rounded-full mt-auto hover:bg-red-600 transition"
        >
          Logout
        </button>
      </div>
